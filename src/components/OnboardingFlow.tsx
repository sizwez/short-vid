        ...
        <div className="max-w-md mx-auto pt-20">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-orange-500 text-white py-4 rounded-xl font-semibold text-lg hover:bg-orange-600 transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {isLoading ? (
                <>
            ...
            >
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 bg-white text-black py-3 rounded-xl font-medium hover:bg-gray-200 transition-colors flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-black text-white py-3 rounded-xl font-medium hover:bg-gray-900 transition-colors flex items-center justify-center gap-2"
                >
        ...
        <div className="max-w-md mx-auto pt-20">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full text-gray-400 py-3 text-sm hover:text-white"
            >
              Forgot Password?
            </button>
